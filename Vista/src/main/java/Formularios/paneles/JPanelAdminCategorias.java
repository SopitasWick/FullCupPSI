 ...
 */
public class JPanelAdminCategorias extends javax.swing.JPanel {
...
//                radioInactivoEditar.setVisible(true);
    ...
    private void initComponents() {
        ...
        add(txtBuscarCategoria);
        txtBuscarCategoria.setBounds(20, 30, 630, 42);
        ...
        add(cbInactivas);
        cbInactivas.setBounds(690, 40, 140, 40);
        ...
        jScrollPane1.setBounds(20, 20, 590, 400);

        add(jPanelListaCategorias);
        jPanelListaCategorias.setBounds(20, 100, 630, 440);
        ...
        txtNombreCategoria.setBounds(20, 70, 210, 42);
        ...
        btnEliminarCategoria.setBounds(20, 240, 210, 50);
        ...
        btnNuevaCategoria.setBounds(20, 150, 210, 60);
        ...
        btnEditarCategoria.setBounds(20, 320, 210, 50);
        ...
        jLabel3.setBounds(20, 20, 210, 24);
        jPanelListaCategorias1.add(jSeparator1);
        jSeparator1.setBounds(0, 220, 250, 3);
        jPanelListaCategorias1.add(jSeparator2);
        jSeparator2.setBounds(0, 300, 250, 10);
        ...
        radioInactivoEditar.setBounds(20, 400, 80, 25);
        ...
        radioActivoEditar.setBounds(160, 400, 70, 25);

        add(jPanelListaCategorias1);
        jPanelListaCategorias1.setBounds(670, 100, 250, 440);
